...
type ICodeceptCallback = (i?: CodeceptJS.I, current?:any, homePage?:CodeceptJS.homePage, searchFragment?:CodeceptJS.searchFragment, searchResultPage?:CodeceptJS.searchResultPage, advertDetailPage?:CodeceptJS.advertDetailPage, ...args: any) => void;
...
declare function inject(): {
  I: CodeceptJS.I
  homePage: CodeceptJS.homePage
  searchFragment: CodeceptJS.searchFragment
  searchResultPage: CodeceptJS.searchResultPage
  advertDetailPage: CodeceptJS.advertDetailPage
};
...
declare namespace CodeceptJS {
  ...
  export interface searchResultPage {
    selectCategory(keyword: string) : void,
    goResultPageNumber(pageNumber: string) : void,
    openSelectRowDetail(row: string) : void,

  }


  export interface advertDetailPage {
